...
namespace DotNet.Utilities
{
    ...
    {
        #region 写文件
        protected void Write_Txt(string FileName, string Content, string Path)
        {
        ...
        #region 读文件
        protected string Read_Txt(string filename,string Path)
        {
        ...
        *****************************************/
        ...
        public static void FileAdd(string Path,string fileName, string strings)
        {
