...
namespace Helper
{
    ...
    class HttpHelper
    {
        ...
        /// 发送get请求得到响应内容
        /// </summary>
        /// <param name="url_prex"></param>
        /// <param name="url"></param>
        /// <param name="paras"></param>
        /// <returns></returns>
        public String requestHttpGet(String url_prex, String url, Dictionary<String, String> paras)
        {
            String param = "";
            foreach (var para in paras)
            {
                if (!string.IsNullOrWhiteSpace(para.Value))
                {
                    ...
                    param += $"{para.Key}={para.Value}" + para.Value;
                }
            }
            return requestHttpGet(url_prex, url, param);
        }
