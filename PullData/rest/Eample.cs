...
namespace com.okcoin.rest
{
    class Client
    {
        ...
        //    }
        //}
        private static void K_Request()
        {
            FutureRestApiV1 getRequest = new FutureRestApiV1("https://www.okex.com");
            System.DateTime startTime = TimeZone.CurrentTimeZone.ToLocalTime(new System.DateTime(1970, 1, 1)); // 当地时区

            long timeStamp = (long)(DateTime.Now - startTime).TotalMilliseconds; // 相差毫秒数
            try
            {
                string result = getRequest.future_kline("eth_usd", "1min", "this_week", "1", Convert.ToString(timeStamp));
            }
            catch (Exception ex)
            {
        ...
        private static void Alex_Request()
        {
            String api_key = "708cc3a9-7591-454a-82e9-f03be6faa1f4";  //OKCoin申请的apiKey
            String secret_key = "987CBC1F23D8285A735E26F371CB9CEE";  //OKCoin申请的secretKey
            String url_prex = "https://www.okex.com"; //国内站账号配置 为 https://www.okex.cn
            ...
            try
            {
                ...
                Console.WriteLine(getRequest.future_kline("eth_usd", "1min", "this_week", "1", Convert.ToString(timeStamp)));
                //Console.WriteLine(postRequest.future_ticker("eth_usd", "this_week"));
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex.Message);
